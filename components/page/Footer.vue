    ...
    <div role="contentinfo"
      ...
      <div class="c-footer__wrapper">
        <ul class="member-footer-links">
          <li class="member-footer-link-wrapper"><span class="member-footer-link-content">Audio Description</span></li>
          <li class="member-footer-link-wrapper"><span class="member-footer-link-content">Gift Cards</span></li>
          <li class="member-footer-link-wrapper"><span class="member-footer-link-content">Corporate Information</span></li>
          <li class="member-footer-link-wrapper"><span class="member-footer-link-content">Contact Us</span></li>
        </ul>
        <ul class="member-footer-links">
          <li class="member-footer-link-wrapper"><span class="member-footer-link-content">Audio Description</span></li>
          <li class="member-footer-link-wrapper"><span class="member-footer-link-content">Gift Cards</span></li>
      ...
      <div class="c-footer__wrapper">
        <div class="social-links"><svg width="24"
               height="24"
               viewBox="0 0 24 24"
               fill="none"
        ...
        <div class="member-footer-copyright"><span>© 1996-2022 Moviemania, Inc.</span></div>
      </div>
    </div>
  </div>
</template>
